...
import 'package:fake_news_app/services/post_api_service.dart';
import 'emotionalAnalysis_screens.dart';
  ...
  void _analyzeInput() async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => EmotionalAnalysisScreen(apiResponse: response),
        ),
      );
    } catch (e) {
      print("Error: $e");
